		...
		<>
			<Container maxWidth="lg" sx={{ padding: 2 }}>
				...
				>
					...
					<Box component={"form"}>
						<FormControl size="medium" sx={{ width: "300px",fontFamily: "var(--font)", }}>
							<Select
								displayEmpty
								value={rate}
				...
				<TableContainer component={Paper} sx={{ marginTop: "20px" }}>
					<Table sx={{ minWidth: 700 }} aria-label="customized table">
						<TableHead>
							<TableRow>
								{/* Table headers */}
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Image</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Name</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Price</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Orders Count</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>rate</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Serves</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Time</StyledTableCell>
								<StyledTableCell align="center" sx={{fontFamily: "var(--font)",}}>Actions</StyledTableCell>
							</TableRow>
						</TableHead>
						<TableBody>
							<MealsTableRows
